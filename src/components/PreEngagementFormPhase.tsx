...
export const PreEngagementFormPhase = () => {
    const { name, email, product, query } = useSelector((state: AppState) => state.session.preEngagementData) || {};
        ...
        <>
            ...
            <Box as="form" data-test="pre-engagement-chat-form" onSubmit={handleSubmit} {...formStyles}>
                ...
                <Box {...fieldStyles}>
                    ...
                    <Select id="product" name="product" onChange={(e) => dispatch(updatePreEngagementData({ product: e.target.value }))} required>
